...
<div class="jumbotron">
    <div class="container">
        ...
        <p><a class="btn btn-primary btn-lg" onClick="parent.location='login.html'">Login</a>
            <a class="btn btn-primary btn-lg" onClick="parent.location='register.html'">Register</a>
            <a class="btn btn-primary btn-lg" onClick="parent.location='facebooktest.html'">Facebook Stuff</a>

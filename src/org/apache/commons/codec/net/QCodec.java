...
public class QCodec extends RFC1522Codec implements StringEncoder, StringDecoder {
     ...
     *
     * @param pObject object to convert to quoted-printable form
     ...
     * @throws DecoderException Thrown if the argument is not a <code>String</code>. Thrown if a failure condition is

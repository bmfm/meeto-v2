...
START TRANSACTION;
USE `meeto`;
INSERT INTO `meeto`.`member` (`idmember`, `username`, `email`, `password`, `online`, `googleid`, `token`)
VALUES (1, 'bruno', 'bruno', 'bruno', 0, NULL, NULL);
INSERT INTO `meeto`.`member` (`idmember`, `username`, `email`, `password`, `online`, `googleid`, `token`)
VALUES (2, 'luis', 'luis', 'luis', 0, NULL, NULL);
INSERT INTO `meeto`.`member` (`idmember`, `username`, `email`, `password`, `online`, `googleid`, `token`)
VALUES (3, 'catarina', 'catarina', 'catarina', 0, NULL, NULL);
INSERT INTO `meeto`.`member` (`idmember`, `username`, `email`, `password`, `online`, `googleid`, `token`)
VALUES (4, 'jose', 'jose', 'jose', 0, NULL, NULL);
INSERT INTO `meeto`.`member` (`idmember`, `username`, `email`, `password`, `online`, `googleid`, `token`)
VALUES (5, 'tome', 'tome', 'tome', 0, NULL, NULL);
INSERT INTO `meeto`.`member` (`idmember`, `username`, `email`, `password`, `online`, `googleid`, `token`)
VALUES (6, 'irene', 'irene', 'irene', 0, NULL, NULL);
